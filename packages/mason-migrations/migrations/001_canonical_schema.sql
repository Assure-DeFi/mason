--------------------------------------------------------------------------------
-- MASON CANONICAL DATABASE SCHEMA
--
-- This file is the canonical SQL schema for Mason, generated from the single
-- source of truth: packages/mason-dashboard/src/app/api/setup/migrations/route.ts
--
-- DO NOT edit this file directly. Instead, edit the MIGRATION_SQL constant in
-- route.ts and regenerate this file to keep them in sync.
--
-- This file supersedes the following legacy migration files:
--   - 001_mason_schema.sql (removed)
--   - 001_pm_backlog_tables.sql (removed)
--   - 002_auth_and_github.sql (changes incorporated)
--   - 003_api_keys.sql (changes incorporated)
--   - 004_production_rls.sql (changes incorporated)
--   - 005_fix_user_registration_rls.sql (changes incorporated)
--   - 006_rename_tables_and_add_user_db_columns.sql (changes incorporated)
--   - 007_privacy_architecture.sql (changes incorporated)
--   - 008_validation_layer.sql (changes incorporated)
--   - 009_ai_provider_keys.sql (changes incorporated)
--   - 010_composite_indexes.sql (changes incorporated)
--   - 011_add_repository_id_to_pm_tables.sql (changes incorporated)
--   - 012_missing_tables.sql (changes incorporated)
--   - 014_notification_channels.sql (changes incorporated)
--   - 015_dlq_metrics_rpc.sql (changes incorporated)
--
