<!-- NOTE: When /pm-review initializes this file, it MUST add "<!-- INITIALIZED: true -->" as the FIRST LINE -->
<!-- This marker prevents the agent from asking setup questions on subsequent runs -->
